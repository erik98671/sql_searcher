...
if __name__ == "__main__":
    ...
    searching_for = "CASE WHEN EXISTS"
    #tool.search_files(index_files[0], searching_for)
    tool.search_files(index_files[1], searching_for)
    #tool.search_files(index_files[2], searching_for)
    #tool.search_files(index_files[3], searching_for)
