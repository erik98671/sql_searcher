...
if __name__ == "__main__":
    ...
    tool.search_files(index_files[0], "Dental only")
    tool.search_files(index_files[1], "Dental only")
    tool.search_files(index_files[2], "Dental only")
    tool.search_files(index_files[3], "Dental only")
